...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 85a4e623-cc03-44b5-9d0f-ca996047226a
```

> `85a4e623-cc03-44b5-9d0f-ca996047226a` is the password of the certificate, you can change it to any password you want.
